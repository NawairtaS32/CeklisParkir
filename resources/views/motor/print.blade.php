            ...
            <table class="table">
                ...
                @if(!empty($motor->problems->no_stnk))
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                                {{$motor->problems->no_stnk}}
                        </td>
                    </tr>
                @endif
                
                @if(!empty($motor->problems->j_kendaraan))
                    <tr>
                        <td class="judul">Jenis Kendaraan</td>
                        <td>:</td>
                        <td>
                                {{$motor->problems->j_kendaraan}}
                            </td>
                    </tr>  
                @endif
                ...
                <tr>
                    <td class="judul">Nama Petugas</td>
                    <td>:</td>
                    <td>{{$motor->users->name}}</td>
                </tr>
                <tr>
                    <td class="judul">Jabatan</td>
                    <td>:</td>
                    <td>{{$motor->users->jabatan}}</td>
                </tr>
                <tr>
                    <td class="judul">Lokasi Parkir</td>
                    <td>:</td>
                    <td>{{$motor->users->lokasi_kerja}}</td>
                </tr>
                <tr>
                ...
                @if(!empty($motor->problems->penanganan))
                    <tr>
                        <td class="judul">Penanganan kejadian</td>
                        <td>:</td>
                        <td>
                                {{$motor->problems->penanganan}}
                            </td>
                    </tr>  
                @endif
